...
(function () {
  ...
  function initCommandPalette() {
    ...
    const COMMANDS = [
      ...
      { group: 'Projects', icon: '≡', label: 'LogFlow',                     meta: 'featured', run: () => goto('#projects') },
      { group: 'Projects', icon: '≡', label: 'LogFlow — source',            meta: 'github ↗', run: () => ext('https://github.com/ahmed2287/logflow') },
